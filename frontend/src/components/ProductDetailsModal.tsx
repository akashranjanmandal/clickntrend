...
import { X, ShoppingCart, Star, ChevronLeft, ChevronRight, ThumbsUp, MessageCircle, Send, PenTool } from 'lucide-react';
...
interface ProductDetailsModalProps {
  product: Product;
  onClose: () => void;
  onCustomize?: () => void; // Add this optional prop
}

const ProductDetailsModal: React.FC<ProductDetailsModalProps> = ({ 
  product, 
  onClose, 
  onCustomize // Add this parameter
}) => {
  ...
  const handleAddToCart = () => {
    if (product.is_customizable) {
      // If onCustomize prop is provided, use it, otherwise handle internally
      if (onCustomize) {
        onCustomize();
      } else {
      ...
      // Add directly to cart and close details modal
  ...
  const handleCustomizationClose = () => {
    ...
    onClose(); // Close details modal as well
  };
              ...
              <div className="space-y-4">
                <div className="relative aspect-square rounded-2xl overflow-hidden bg-gray-100">
                  ...
                  {product.is_customizable && (
                    <div className="absolute bottom-4 right-4 bg-purple-600 text-white px-3 py-1.5 rounded-full text-sm font-semibold shadow-lg flex items-center gap-1.5">
              ...
              <div className="space-y-6">
                ...
                <div className="pt-6 border-t">
                  ...
                  >
                    ...
                    {product.is_customizable ? 'Customize & Add to Cart' : `Add to Cart • ${formatCurrency(product.price * quantity)}`}
                  </button>
                </div>
              </div>
            </div>
