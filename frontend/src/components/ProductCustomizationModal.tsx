...
interface ProductCustomizationModalProps {
  ...
  selectedImageUrl?: string; // Pass the currently-selected color image URL
}
...
const ProductCustomizationModal: React.FC<ProductCustomizationModalProps> = ({ 
  ...
  const maxImages = product.max_customization_images || 0; 
  const maxLines = product.max_customization_lines || 0; 
              ...
              <div className="lg:w-1/2" onClick={handleModalClick}>
                ...
                <div className="space-y-4">
                  ...
                  <div className="relative border rounded-lg overflow-hidden bg-gray-50 aspect-square">
                    <img
                      src={getImageUrl(selectedImageUrl || product.image_url)}
                      alt="Product"
